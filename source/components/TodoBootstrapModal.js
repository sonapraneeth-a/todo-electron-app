...
class TodoBootstrapModal extends React.Component
{
  constructor(props)
  {
    super(props);
            ...
            <div className="modal-body">
              ...
              { todoTitle != "" && todoTitle != null && 
                <div className="input-group" style={{margin: "10px auto"}}>
                  ...
                  <input key="createTodoTitle" type="text" className="form-control is-valid" placeholder={"Title for the TODO"} aria-label="TodoTitle" aria-describedby="basic-addon1" onChange={this.handleTitle.bind(this)}/>
                </div>
              }
              { (todoTitle == "" || todoTitle == null) && 
                <div className="input-group" style={{margin: "10px auto"}}>
...
export default TodoBootstrapModal;
